...
This folder is the active data area for the Ethiopia maize forecast use case.
...
```text
season start: 2025-06-01
forecast initialization: 2025-05-01
lead time: 1 month
...
outputs when the Ethiopia use case is executed.
