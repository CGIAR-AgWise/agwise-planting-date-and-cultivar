#!/usr/bin/env Rscript
###############################################################################
# Script: 02_ethiopia_maize_forecast.R
# Purpose: Run the Ethiopia maize use case from its YAML configuration.
#
...
run_usecase_config("configs/ETH/maize_national.yml")
